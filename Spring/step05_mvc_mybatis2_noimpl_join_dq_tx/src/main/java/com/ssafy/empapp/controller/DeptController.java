...
public class DeptController  {
	...
	protected String getDeptList(Model model) throws Exception {
		...
		List<Dept> depts = deptService.getDepts(null);
	...
	protected String getDeptListByCondition(@RequestParam Map<String,Object> condition , Model model) throws Exception {
