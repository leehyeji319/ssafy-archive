...
public class UserController {
	...
	protected String signup(String userId, String password, String userName, String userEmail, HttpSession session, Model model) throws Exception
	{
		boolean res = userService.signup(userId, password, userName, userEmail);
		if(res)
		{
		...
		{
			return "redirect:/user/signup_form.do";
		}
	}
}
