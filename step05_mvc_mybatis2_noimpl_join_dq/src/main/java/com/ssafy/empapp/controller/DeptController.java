...
public class DeptController  {
	...
	protected String getDeptList(Model model) throws Exception {
		...
		if(model.getAttribute("deptList") == null)
		{
...
//			rAttributes.addAttribute("msg", "부서 수정에 실패하였습니다.");
	...
	protected String searchByKeywords(@RequestParam Map<String, String> map, Model model) throws Exception {
		
		List<Dept> deptList = deptService.searchByDNameAndDLoc(map);
		model.addAttribute("deptList", deptList); // request 보관함에 저장
