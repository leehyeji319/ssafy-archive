...
public class InterestAreaDaoImpl implements InterestAreaDao {
	...
	@Override
	public ArrayList<InterestAreaDto> selectInterestAreas(String userId) throws SQLException {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		ArrayList<InterestAreaDto> interestAreaList = new ArrayList<>();
		...
		try {
			...
			while(rs.next()) {
				interestAreaList.add(new InterestAreaDto(rs.getString(1), rs.getString(2), rs.getString(3), 
